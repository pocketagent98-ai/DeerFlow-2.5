...
| **z.ai paid-model safety** | `providers/discovery.py` | Only the three documented free models are ever used. The models listing is informational only — it can neither add paid models nor remove the free ones (live-verified 2026-09-16). |
